...
RC IX_BTree::InsertEntry(void *pData, const RID &rid)
{
    RC rc;
...
RC IX_BTree::InsertEntry_t(T iValue, const RID &rid)
{
    RC rc;
    PageNum pageNum;
...
// Node insertion
template <typename T, int n>
RC IX_BTree::InsertEntryInNode_t(PageNum iPageNum, T iValue, const RID &rid, PageNum &newNodePageNum,T &medianParentValue)
{
    RC rc;
...
// Leaf insertion
template <typename T, int n>
RC IX_BTree::InsertEntryInLeaf_t(PageNum iPageNum, T iValue, const RID &rid, PageNum &newChildPageNum,T &medianValue)
{
    RC rc = OK_RC;
...
template <typename T, int n>
RC IX_BTree::RedistributeValuesAndChildren(IX_PageNode<T,n> *pBufferCurrentNode, IX_PageNode<T,n> *pBufferNewNode,T &medianChildValue, T &medianParentValue,const PageNum &newNodePageNum)
{
    T array[n+1];
    PageNum child[n+1];
...
template <typename T, int n>
RC IX_BTree::RedistributeValuesAndBuckets(IX_PageLeaf<T,n> *pBufferCurrentLeaf, IX_PageLeaf<T,n> *pBufferNewLeaf, T iValue, T &medianValue,const PageNum &bucketPageNum, const int nEntries, bool redistributionOnly)
{
    T arr[nEntries];
...
// bucket insertion
RC IX_BTree::InsertEntryInBucket(PageNum iPageNum, const RID &rid)
{
    RC rc = OK_RC;
    char *pBuffer;
    RID tempRID;
...
RC IX_BTree::DeleteEntry(void *pData, const RID &rid)
{
    RC rc;
...
// templated Deletion
template <typename T, int n>
RC IX_BTree::DeleteEntry_t(T iValue, const RID &rid)
{
    RC rc;
    PageNum pageNum;
...
// Node Deletion
template <typename T, int n>
RC IX_BTree::DeleteEntryInNode_t(PageNum iPageNum, T iValue, const RID &rid, T &updatedParentValue, DeleteStatus &parentStatus)
{
    RC rc;
...
// Leaf Deletion
template <typename T, int n>
RC IX_BTree::DeleteEntryInLeaf_t(PageNum iPageNum, T iValue, const RID &rid, T &updatedParentValue, DeleteStatus &parentStatus)
{
    RC rc = OK_RC;
...
template <typename T, int n>
RC IX_BTree::MergeValuesAndBuckets(IX_PageLeaf<T,n> *pBufferCurrentLeaf, IX_PageLeaf<T,n> *pBufferNewLeaf, const int nEntries)
{
    T arr[nEntries];
    PageNum buck[nEntries];
...
template <typename T, int n>
RC IX_BTree::DeleteNodeValue(IX_PageNode<T,n> *pBuffer, const int & slotIndex, const int nEntries)
{
...
// bucket Deletion
RC IX_BTree::DeleteEntryInBucket(PageNum &ioPageNum, const RID &rid)
{
    RC rc = OK_RC;
...
// node page
template <typename T, int n>
RC IX_BTree::AllocateNodePage_t(const NodeType nodeType, const PageNum parent, PageNum &oPageNum)
{
    RC rc;
...
// leaf page
template <typename T, int n>
RC IX_BTree::AllocateLeafPage_t(const PageNum parent, PageNum &oPageNum)
{
    RC rc;
    PF_PageHandle pageHandle;
    char *pReadData;
...
// RID bucket page
RC IX_BTree::AllocateBucketPage(const PageNum parent, PageNum &oPageNum)
{
    RC rc;
    PF_PageHandle pageHandle;
    char *pReadData;
...
RC IX_BTree::GetPageBuffer(const PageNum &iPageNum, char * & pBuffer) const
{
    RC rc;
    PF_PageHandle pageHandle;
...
template <typename T, int n>
RC IX_BTree::GetNodePageBuffer(const PageNum &iPageNum, IX_PageNode<T,n> * & pBuffer) const
{
    RC rc;
    char * pData;
...
template <typename T, int n>
RC IX_BTree::GetLeafPageBuffer(const PageNum &iPageNum, IX_PageLeaf<T,n> * & pBuffer) const
{
    RC rc;
    char * pData;
...
// release the buffer
RC IX_BTree::ReleaseBuffer(const PageNum &iPageNum, bool isDirty) const
{
    RC rc;
...
// display node
template <typename T, int n>
RC IX_BTree::DisplayNode_t(const PageNum pageNum, const int fatherNodeId, int &currentNodeId, int &currentEdgeId)
{
    RC rc;
    char *pBuffer;
    int slotIndex;
...
// display leaf
template <typename T, int n>
RC IX_BTree::DisplayLeaf_t(const PageNum pageNum,const int fatherNodeId, int &currentNodeId, int &currentEdgeId)
{
    RC rc;
...
template <int n>
void IX_BTree::sortNodeGeneric(int *array, PageNum child[n+1], const int arrayLength)
{
...
template <int n>
void IX_BTree::sortNodeGeneric(float *array, PageNum child[n+1], const int arrayLength)
{
  // on crée un tableau temporaire avec uniquement les fils droits
  PageNum temporaryChild[n];
  // on le remplit
...
template <int n>
void IX_BTree::sortNodeGeneric(char array[][MAXSTRINGLEN], PageNum child[n+1], const int arrayLength)
{
  // on crée un tableau temporaire avec uniquement les fils droits
  PageNum temporaryChild[n];
  // on le remplit
...
template <typename T, int n>
void IX_BTree::swapLeafEntries(int i, IX_PageLeaf<T,n> * pBuffer1, int j, IX_PageLeaf<T,n> *pBuffer2)
{
    T tempV;
    PageNum tempNum;
...
template <typename T, int n>
void IX_BTree::sortLeaf(IX_PageLeaf<T,n> * pBuffer)
{
    sortGeneric(pBuffer->v, pBuffer->bucket, pBuffer->nbFilledSlots);
}
...
template <typename T, int n>
void IX_BTree::setOffsetInNode(IX_PageNode<T,n> *pBuffer, const int offset)
{
...
template <typename T, int n>
void IX_BTree::removeFirstChildrenInNode(IX_PageNode<T,n> *pBuffer, const int offset)
{
...
template <typename T, int n>
void IX_BTree::removeInNode(IX_PageNode<T,n> *pBuffer, const int slotIndex, const int pointerIndex)
{
    for(int i=slotIndex+1; i<pBuffer->nbFilledSlots; i++)
    {
        copyGeneric(pBuffer->v[i], pBuffer->v[i-1]);

...
CFLAGS         = -m32 -g -O0 $(STATS_OPTION) $(INC_DIRS)
...
QL_SOURCES     = ql_common.cc ql_treeplan.cc ql_treeplandelete.cc ql_manager.cc ql_error.cc ql_helpers.cc it_indexscan.cc it_filescan.cc
